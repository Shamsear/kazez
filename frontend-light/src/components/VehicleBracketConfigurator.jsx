...
export const VehicleBracketConfigurator = ({ 
  ...
  return (
    <div className={`kz-bracket-configurator ${compact ? 'compact' : ''} ${includeBracket ? 'expanded' : 'collapsed'}`}>
      {/* Smart Bundle Option Toggle at TOP */}
      {onToggleIncludeBracket && (
        <div 
      ...
      {/* Bracket Configurator Details Shown ONLY When Selected */}
      {includeBracket && (
